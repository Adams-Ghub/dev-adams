  ...
  return (
    <div className=" flex flex-row w-screen h-full ">
      ...
      <div
        ...
        } w-[20%] sm:w-[10%] fixed top-0 left-0 z-10 md:static  bg-[#0a0f14] border-solid border-r border-r-[#ffffff]`}
      >
        <div className="flex flex-col justify-start gap-[1rem] items-center h-screen sticky top-0">
          <a
            href="#headline"
            onClick={handleToggleMenu}
